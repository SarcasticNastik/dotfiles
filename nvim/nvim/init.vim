...
" Set colorscheme for Coqtail
" {{{
" augroup CoqtailHighlights
"   autocmd!
"   autocmd ColorScheme *
"     \  hi def CoqtailChecked ctermbg=3 
"     \| hi def CoqtailSent    ctermbg=4
" augroup END
"}}}

if &t_Co > 16
  hi def CoqtailChecked ctermbg=17 guibg=Gray
  hi def CoqtailSent    ctermbg=60 guibg=LightGray
else
  hi def CoqtailChecked ctermbg=3 guibg=Blue
  hi def CoqtailSent    ctermbg=4 guibg=Yellow
endif
...
let g:coc_root_patterns = ['.git', '.env', '.toml']
"
